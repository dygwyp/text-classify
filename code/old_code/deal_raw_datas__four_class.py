...
if __name__ == '__main__':
    ...
    le_path_list = []
    le_add_path = '../datas/infos/category/区域分类.xlsx'
    le_ind_path = '../datas/infos/category/行业分类.xlsx'
    le_sub_path = '../datas/infos/category/学科分类.xlsx'
    le_ch_path = '../datas/infos/category/classify_list.xlsx'
