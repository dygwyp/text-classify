...
def fastText_classifier(train_data,model_save_path,result_save_path):
    classifier=ff.train_supervised(train_data+'level_3_train.txt',lr=0.1,loss='hs',wordNgrams=2,epoch=150) 
    model = classifier.save_model(model_save_path+'level_3_classifier.model') # 保存模型
...
if __name__ == '__main__':
    ...
    ori_path2 = '../datas/data_set/original_datas/data_new.txt'
    ...
    # con_to_levn(con1,ori_path1,le_file_path,save_path,le_n,stopword_path)
    
    train_path = '../datas/data_set/level_3_new/train/'
    model_save_path = '../datas/model/level3_train/'
    result_save_path = '../datas/results/level3_train/'
    fastText_classifier(train_path,model_save_path,result_save_path)
